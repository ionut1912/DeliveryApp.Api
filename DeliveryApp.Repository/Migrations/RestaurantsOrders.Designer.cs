...
namespace DeliveryApp.Repository.Migrations
{
    ...
    [Migration("20230408095004_RestaurantsOrders")]
    partial class RestaurantsOrders
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DeliveryApp.Repository.Entities.Roles", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            ConcurrencyStamp = "fe4d7810-da47-4a98-83f8-0bc53925eb48",
                            Name = "Member",
                        ...
                        {
                            Id = 2,
                            ConcurrencyStamp = "2f145c5c-b625-4790-a020-47df39cbdc42",
                            Name = "Admin",
            ...
            modelBuilder.Entity("OrdersRestaurants", b =>
                {
                    b.Property<Guid>("OrdersId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasKey("OrdersId", "RestaurantsId");

                    b.HasIndex("RestaurantsId");

                    b.ToTable("OrdersRestaurants");
                });
