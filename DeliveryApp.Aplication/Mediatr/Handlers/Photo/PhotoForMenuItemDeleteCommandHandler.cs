    ...
    PhotoForMenuItemDeleteCommandHandler : ICommandHandler<PhotoForMenuItemDeleteCommand, ResultT<JsonResponse>>
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        if (result is false)
        {
            ...
            {
                Message = DomainMessagesEn.PhotoForMenuItem.CanNotDeletePhoto(request.PhotoId)
            };
        ...
        {
            Message = DomainMessagesEn.PhotoForMenuItem.PhotoDeletedSuccessfully(request.PhotoId)
        };
